...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-lg space-y-4 rounded-lg border bg-white p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-navy">Something went wrong</h2>
        <p className="text-sm text-muted-foreground">
          The dashboard failed to load after login. This is usually caused by
          missing database environment variables or tables not created in
          Supabase.
        </p>
        {error.digest && (
